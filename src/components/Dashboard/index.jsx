            ...
            <div className="dashboard">
                ...
                <div className="wrapper">
                    ...
                    <div className="total">
                        ...
                        <div onClick={()=>this.props.history.push("/Vendors")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Shops</p>
                        ...
                        <div onClick={()=>this.props.history.push("/VendorsRe")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Vendors Requests</p>
                                
                            </div>
                        </div>

                        <div onClick={()=>this.props.history.push("/Inspections")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Inspections</p>
                        ...
                        <div onClick={()=>this.props.history.push("/updateproduct/")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Update Products</p>
                        ...
                        <div onClick={()=>this.props.history.push("/InspectorAdd")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Add Inspector</p>
                        ...
                        <div onClick={()=>this.props.history.push("/Inspectors")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>See Inspectors</p>
                        ...
                        <div onClick={()=>this.props.history.push("/InspectionsRe")} className="card">
                            <div><i className="demo-icon icon-costumers">&#xe80a;</i></div>
                            <div>
                                <p>Inspections Requests</p>
