...
class Category extends Component {
    ...
    deleteCategory(id) {   
       firest.collection('Categories').get().then(documemntSnapshot => {
           documemntSnapshot.forEach((doc)=>{
               const {Name} = doc.data();
               if(Name===id)
               {
                   firest.collection('Categories').doc(doc.id).delete();
                   console.log(doc.id)
                ...
                { //open comfirm delete category
                    ...
                    <div className="comfirm-delete">
                        <div>
                            ...
                            <button onClick={()=>{this.deleteCategory(category.Name)}}>Yes</button>
