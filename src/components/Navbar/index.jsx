...
export default function index(props) {
    return (
        <div className="navbar">
            ...
            <NavLink className="link" to="/Vendors" activeClassName="active" > <i className="demo-icon icon-tags">&#xe816;</i><span> Shops</span> </NavLink>
            <NavLink className="link" to="/Inspections" activeClassName="active" > <i className="demo-icon icon-tags">&#xe816;</i><span> Inspections</span> </NavLink>
            <NavLink className="link" to="/InspectionsRe" activeClassName="active" > <i className="demo-icon icon-tags">&#xe816;</i><span> Inspection ReQuests</span> </NavLink>
            <NavLink className="link" to="/VendorsRe" activeClassName="active" > <i className="demo-icon icon-tags">&#xe816;</i><span> Vendor ReQuests</span> </NavLink>
        </div>
    );
}